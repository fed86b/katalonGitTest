...
'choose template  '
RolesHelper.getCm_En().getGeneral()._choose_Template_By_Typing()

'fill property tab'
RolesHelper.getCm_En().getGeneral().getItem_property_tab_general()._fill_property_tab()

'fill general tab'
RolesHelper.getCm_En().getGeneral().getGeneral_tab().getHtml_Editor()._click_Edit_HTML()
...
'click home page'
not_run: RolesHelper.getCm_En().getUpper_bar()._click_Home_Button()

'logout from system'
not_run: RolesHelper.getCm_En().getUpper_bar()._logout()
